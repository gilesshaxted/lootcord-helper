...
const damageCalcCommand = require('../commands/damage-calc.js'); // Import the damage-calc command

// Custom IDs for interactions
const TRIVIA_EXPLANATION_BUTTON = 'show_trivia_explanation_';

module.exports = {
    name: 'interacti onCreate',
    once: false,
    async execute(interaction, db, client, isFirestoreReady, APP_ID_FOR_FIRESTORE) {
        ...
        // We handle these interactions first because they are multi-step and
        // use specific custom IDs.
        if (interaction.customId.startsWith('damage_calc_')) {
            ...
            return; // Exit after handling damage-calc interactions
        }
